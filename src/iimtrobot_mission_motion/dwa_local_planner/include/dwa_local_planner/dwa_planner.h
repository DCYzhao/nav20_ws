...
class DWAPlanner {
 public:
   ...
   * @param total_cost Will be set to the value of the overall cost function, taking into account the scaling
   * parameters
 ...
 private:
  ...
  double stop_time_buffer_;  ///< @brief How long before hitting something we're going to enforce that the
                             ///< robot stop
  ...
  base_local_planner::MapGridVisualizer map_viz_;  ///< @brief The map grid visualizer for outputting the
                                                   ///< potential field generated by the cost function
